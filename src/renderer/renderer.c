...
static struct fcolor color1 = {0.5803921f, 0.5803921f, 1.0000000f};
static struct fcolor color2 = {0.0000000f, 0.0000000f, 0.0000000f};
...
static void render_number_zero_padding(unsigned int number, unsigned char size,
				       short x, short y)
{
	while (size--) {
...
{
	glBindBuffer(GL_ARRAY_BUFFER, b_pos);
	glBufferSubData(GL_ARRAY_BUFFER, 0, sizeof(struct vec2) * bd_count,
			bd_pos);
...
void renderer_texture(unsigned char t, short x, short y)
{
	switch (t) {
	case TEXTURE_LOGO: {
		render_tileset(tilesets[TILESET_LOGO_BOARD], PALETTESET_STONE,
			       x, y);
		render_tileset(tilesets[TILESET_BIG_S_SHADOW], PALETTESET_STONE,
			       x + 9, y + 12);
		render_tileset(tilesets[TILESET_BIG_S], PALETTESET_STONE, x + 8,
			       y + 8);

		render_tileset(tilesets[TILESET_BIG_U_SHADOW], PALETTESET_STONE,
			       x + 25, y + 12);
		render_tileset(tilesets[TILESET_BIG_U], PALETTESET_STONE,
			       x + 24, y + 8);

		render_tileset(tilesets[TILESET_BIG_P_SHADOW], PALETTESET_STONE,
			       x + 41, y + 12);
		render_tileset(tilesets[TILESET_BIG_P], PALETTESET_STONE,
			       x + 40, y + 8);

		render_tileset(tilesets[TILESET_BIG_E_SHADOW], PALETTESET_STONE,
			       x + 57, y + 12);
		render_tileset(tilesets[TILESET_BIG_E], PALETTESET_STONE,
			       x + 56, y + 8);

		render_tileset(tilesets[TILESET_BIG_R_SHADOW], PALETTESET_STONE,
			       x + 73, y + 12);
		render_tileset(tilesets[TILESET_BIG_R], PALETTESET_STONE,
			       x + 72, y + 8);

		render_tileset(tilesets[TILESET_BIGGER_M_SHADOW],
			       PALETTESET_STONE, x + 9, y + 44);
		render_tileset(tilesets[TILESET_BIGGER_M], PALETTESET_STONE,
			       x + 8, y + 40);

		render_tileset(tilesets[TILESET_BIGGER_A_SHADOW],
			       PALETTESET_STONE, x + 33, y + 44);
		render_tileset(tilesets[TILESET_BIGGER_A], PALETTESET_STONE,
			       x + 32, y + 40);

		render_tileset(tilesets[TILESET_BIGGER_R_SHADOW],
			       PALETTESET_STONE, x + 49, y + 44);
		render_tileset(tilesets[TILESET_BIGGER_R], PALETTESET_STONE,
			       x + 48, y + 40);

		render_tileset(tilesets[TILESET_BIGGER_I_SHADOW],
			       PALETTESET_STONE, x + 65, y + 44);
		render_tileset(tilesets[TILESET_BIGGER_I], PALETTESET_STONE,
			       x + 64, y + 40);

		render_tileset(tilesets[TILESET_BIGGER_O_SHADOW],
			       PALETTESET_STONE, x + 73, y + 44);
		render_tileset(tilesets[TILESET_BIGGER_O], PALETTESET_STONE,
			       x + 72, y + 40);

		render_tileset(tilesets[TILESET_BIGGER_B_SHADOW],
			       PALETTESET_STONE, x + 97, y + 44);
		render_tileset(tilesets[TILESET_BIGGER_B], PALETTESET_STONE,
			       x + 96, y + 40);
		...
		render_tileset(tilesets[TILESET_BIGGER_S], PALETTESET_STONE,
			       x + 144, y + 40);

		render_tile(TILE_BIGGER_DOT_SHADOW, PALETTESET_STONE, x + 161,
			    y + 76, 0);
		render_tile(TILE_BIGGER_DOT, PALETTESET_STONE, x + 160, y + 72,
			    0);
		break;
	}
	}
